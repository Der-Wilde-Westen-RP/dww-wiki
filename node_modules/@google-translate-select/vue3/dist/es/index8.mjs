...
function z(e, a = V, r = {}) {
  let { immediate: t = !0, type: n = "text/javascript", async: o, crossOrigin: c, defer: m = !0, document: l = L, attrs: S = {} } = r, p = null, g = null, I = (u) => new Promise((f, $) => {
    ...
    s ? s.hasAttribute("data-loaded") && w(s) : (s = l.createElement("script"), s.type = n, s.src = e, s.defer = m, o && (s.async = o), c && (s.crossOrigin = c), Object.entries(S).forEach(([i, M]) => s == null ? void 0 : s.setAttribute(i, M)), h = !0), s.addEventListener("error", (i) => $(i)), s.addEventListener("abort", (i) => $(i)), s.addEventListener("load", () => {
